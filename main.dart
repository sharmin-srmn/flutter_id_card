          ...
          child: Column(
            children: [
                    ...
                    children: [
                      RotatedBox(
                        ...
                        child: Text(
                          "STUDENT",
                          style: TextStyle(
                              color: Colors.white, fontWeight: FontWeight.w700, letterSpacing: 4, fontSize: 20),
                        ),
                      ),
                      CircleAvatar(
                        radius: 75,
              ...
              Padding(
                ...
                child: Image.network(
                  'https://see.fontimg.com/api/renderfont4/1Gz24/eyJyIjoiZnMiLCJoIjoxNzEsInciOjI2MjUsImZzIjo2NSwiZmdjIjoiIzAwMDAwMCIsImJnYyI6IiNGRkZGRkYiLCJ0IjoxfQ/U29sdXN0ae6Ajw/solustion-demo.png',
                  scale: 8,
